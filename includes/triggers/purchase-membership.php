...
class AutomatorWP_MemberPress_Purchase_Membership extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a membership', 'automatorwp-memberpress-integration' ),
            'select_option'     => __( 'User purchases <strong>a membership</strong>', 'automatorwp-memberpress-integration' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases %1$s %2$s time(s)', 'automatorwp-memberpress-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User purchases %1$s', 'automatorwp-memberpress-integration' ), '{post}' ),
            'action'            => array(
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Membership:', 'automatorwp-memberpress-integration' ),
                    'option_none_label' => __( 'any membership', 'automatorwp-memberpress-integration' ),
